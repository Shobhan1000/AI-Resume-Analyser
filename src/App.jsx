...
function App() {
  ...
  const analyseResume = async (text) => {
      ...
      [
        {
          role: "system",
          content:
            "You are an expert resume reviewer. Provide feedback based on the given resume text.",
        },
  ...
  const handleFileUpload = async (event) => {
    ...
    try {
      ...
      setAnalysis(await analyseResume(text));
    } catch (error) {
      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        {analysis && uploadedFile && (
          <div className="space-y-6 p-4 sm:px-8 lg:px-16">
            <div className="file-info-card"></div>
            ...
            <div className="section-card group">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold text-purple-300">Resume Insights</h2>
              </div>
                ...
                <div className="info-box-cyan group/item">
                  ...
                  <div className="space-y-2">
                    {(analysis.actionItems || [
                      "Optimise keyword placement for better ATS scoring",
                ...
                <div className="info-box-emerald group/item">
                    ...
                    <div className="space-y-2">
                      {(analysis.proTips || [
                        ...
                        "Keep decriptions concise and impactful",
                ...
                <div className="flex items-start gap-3 mb-3">
                  <div>
                    ...
                    <p className="text-slate-200 text-sm leading-relaxed">
                      ...
                      are software tools used by 75%+ of employers to automaticcally screen resumes before human review. They scan for keywords, formatting and structure to rank candidates. If your resume isn't ATS-fiendly, it mayn never reach a human recruiter.
                    </p>
                  </div>
                </div>
              </div>
